<template>
  <div ref="rootEl" class="border border-gray-200 rounded-lg bg-white overflow-hidden">
    <!-- ── Header ─────────────────────────────────────────────────────────── -->
    <div
    ...
    <div
      v-if="tagEntries.length === 0 && allDetectedTags.length > 0"
      class="py-2 text-center border-t border-gray-100"
    >
      <span class="text-[11px] text-gray-500"
    ...
    <!-- ── Tag origins ───────────────────────────────────────────────────── -->
    <div v-if="tagOrigins.size > 0" class="border-t border-gray-200 px-3 py-2">
      <span
        class="text-[10px] font-medium text-gray-400/75 uppercase tracking-wider"
        >Tag origins</span
      >
      <div class="mt-1.5 space-y-1">
        <div
          ...
          :key="tag"
          class="flex items-start gap-2 text-[10px] text-gray-500"
        >
          <span class="font-mono text-gray-700 shrink-0">{{ tag }}</span>
