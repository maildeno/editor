<template>
  <div class="w-full md-surface-sidebar-inner flex flex-col h-[calc(100vh-7.5rem)]">
    ...
    <div class="md-tabstrip flex gap-4 px-2 pt-2 shrink-0">
      ...
      >
        <span class="flex items-center gap-1.5 text-sm">
          ...
          <span
            v-if="rows.length > 0"
            class="inline-flex items-center justify-center min-w-[16px] h-4 px-1 text-[10px] font-medium rounded-full bg-gray-100 text-gray-500"
          >
            {{ rows.length }}
          </span>
        </span>
    ...
    >
      ...
      >
        <div
          class="w-10 h-10 rounded-xl bg-gray-100 flex items-center justify-center mb-3"
        >
          <svg
            class="w-5 h-5 text-gray-400 -translate-x-0.5 -translate-y-0.5"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        <p class="text-sm font-medium text-gray-500 mb-1">Nothing selected</p>
      ...
      >
        ...
        <div class="flex items-center justify-between gap-2 mb-4">
          <div
            class="flex items-center gap-1 p-0.5 bg-gray-100 rounded-lg flex-1"
          >
            <button
              @click="activeTab = 'row'"
            ...
            >
              ...
              <span
                v-if="selectedColumn"
                class="inline-flex items-center justify-center min-w-4.5 h-4 px-1 text-[9px] font-medium bg-gray-200 text-gray-700 rounded-full"
              >
        ...
        <div v-else-if="activeTab === 'column'">
          ...
          <template v-else>
            <div
              ...
              class="flex flex-wrap gap-3 mb-4 border-b border-gray-100"
            >
              <button
      ...
      <div v-else-if="selectedComponent" class="space-y-4">
        ...
        >
          <div>
            ...
            <p class="text-xs text-gray-500">Component Properties</p>
          </div>
          <div class="relative group/btn">
            <button
              @click="handleDelete"
            ...
            <div
              class="pointer-events-none absolute -bottom-[125%] left-2/2 -translate-x-2/2 mb-2 px-2 py-1 bg-gray-900 text-white text-xs font-medium rounded-md whitespace-nowrap opacity-0 group-hover/btn:opacity-100 translate-y-1 group-hover/btn:translate-y-0 transition-all duration-150 z-50 after:content-[''] after:absolute after:bottom-full after:right-2 after:-translate-x-1/2 after:border-4 after:border-transparent after:border-t-gray-900 after:rotate-180"
            >
              Delete block
            </div>
          </div>
