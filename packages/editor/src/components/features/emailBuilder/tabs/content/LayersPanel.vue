  ...
  <div class="flex flex-col h-full bg-white">
    ...
    <div class="px-3 py-2 border-b border-gray-100">
      <div class="relative">
        ...
        <input
          ...
          class="w-full pl-7 pr-7 py-1.25 text-[13px] bg-transparent border border-gray-100 rounded-md focus:outline-none focus:border-gray-300 transition-colors placeholder-gray-400"
        />
        <button
          v-if="searchQuery"
          @click="searchQuery = ''"
          class="absolute right-2 top-1/2 -translate-y-1/2 w-4 h-4 flex items-center justify-center text-gray-400 hover:text-gray-600 transition-colors"
      ...
      <template v-for="(row, rowIdx) in filteredRows" :key="row.id">
        ...
        >
          ...
          >
            <!-- Drag grip -->
            <span
              class="size-3.25 mr-0.5 text-gray-700 hover:text-gray-800 shrink-0 cursor-grab active:cursor-grabbing opacity-0 group-hover/row:opacity-100 transition-opacity"
            >
            ...
            <button
              ...
              class="w-4.75 h-4.75 flex items-center justify-center text-gray-400 hover:text-gray-500 transition-transform shrink-0"
            ...
            <button
              v-else
              @click.stop
              class="w-4.5 h-3.75 flex items-center justify-center text-gray-500 shrink-0"
            >
              <svg
                class="w-3.25 h-3.25 text-gray-600 shrink-0"
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
              >
            ...
            <svg
              ...
              :class="
                isRowSelected(row.id) ? 'text-purple-400' : 'text-gray-500'
              "
            >
            ...
            <svg
              ...
              :class="
                isRowSelected(row.id) ? 'text-purple-400' : 'text-gray-600'
              "
            >
            ...
            <template v-if="renamingRowId === row.id">
              <input
                ...
                type="text"
                class="flex-1 min-w-0 px-2 py-0.75 text-sm outline-1 outline-gray-200 rounded-md shadow-xs focus:outline-none focus:ring-[1px] focus:ring-purple-400 translate-y-px text-gray-700"
                @click.stop
                @mousedown.stop
            ...
            <template v-else>
              <span
                class="text-sm text-gray-600 tracking-wider truncate flex-1 min-w-0"
            ...
            <span
              ...
              class="shrink-0 size-5 grid place-content-center rounded-full bg-gray-100 text-gray-500 text-[10px]"
            >
              {{ row.columns.length }}
            </span>
            <!-- Visibility badge -->
    ...
    >
      ...
      <button
        ...
        @click="collapseAll"
        class="text-[10px] text-gray-500 hover:text-gray-600 transition-colors"
      >
        Collapse all
      </button>
    </div>
